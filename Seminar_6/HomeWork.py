...
# Выбрал процедурную парадигму так как она самая лучшая по моему мнению, 
# так как теперь я могу использовать этот секундомер в любом месте просто вызвав функцию